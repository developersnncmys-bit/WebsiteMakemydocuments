...
export default function UKVisaForm() {
  ...
  const submitPayment = async () => {
    ...
    const r = await paytmCheckout({
      orderId, amount: 99, service: "UK Tourist Visa", mobile, name,
    })
        ...
        <div className="pf5-summary-card">
          ...
          <div className="pf5-summary-rows">
            {[
              ...
              { label: 'Services',             value: 'UK Tourist Visa' },
  ...
  return (
    <div className="pf5-page">
      <div className="pf5-breadcrumb">
        <Link href="/">Home</Link><span> / </span><Link href="/uk-visa">UK Visa</Link><span> / </span><span>Form</span>
      </div>
      <div className="pf5-card">
