...
import {
  Car, FileText, Phone, Check, AlertCircle,
  ChevronRight, ChevronLeft, ArrowLeft,
} from 'lucide-react'
import { getStates, getDistricts, validatePincode } from '../data/locationData'

const TOTAL = 3
const STEPS = ['Intent', 'Car', 'Contact']

const STEP_META = [
  { title: 'I Want To',            sub: 'Buy / Renew car insurance without inspection or paperwork', Icon: Car,     gradient: 'linear-gradient(135deg,#1A3D6E,#2E68B1)' },
  { title: 'Enter Car Details',    sub: 'Buy Insurance, the smart way',                              Icon: FileText, gradient: 'linear-gradient(135deg,#1A3D6E,#2E68B1)' },
  { title: 'Contact Details',      sub: 'Buy Insurance, the smart way',                              Icon: Phone,    gradient: 'linear-gradient(135deg,#1A3D6E,#2E68B1)' },
]

const INTENT_OPTIONS = [
  { value: 'Buy New Policy',        label: 'Buy New Policy',        desc: 'Purchase a fresh insurance policy for your four-wheeler',  color: '#2E68B1', bg: '#EBF2FB', badge: 'Recommended' },
...
export default function FourWheelerInsuranceForm() {
  ...
  return (
    <div className="pf5-page">
      <div className="pf5-breadcrumb">
        ...
        <span> / </span>
        <Link href="/four-wheeler-insurance">Four-Wheeler Insurance</Link>
        <span> / </span>
        <span>Form</span>
      </div>
      <div className="pf5-card">
            ...
            <>
              ...
              <Field label="Registration Date">
                {(() => {
                  ...
                  const isTooOld = selected && selected < new Date('1980-01-01')
                    ...
                    <>
                      <ValidInp valid={isValid}>
                        <input
                          ...
                          type="date" max={today.toISOString().split('T')[0]} min="1980-01-01"
                          value={regDate}
