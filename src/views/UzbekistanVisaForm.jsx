...
export default function UzbekistanVisaForm() {
  ...
  const verifyOtp = async () => {
    ...
    submitLead({
      orderId,
      service: 'Uzbekistan Tourist Visa',
      name,
      mobileNumber: mobile,
      email,
      address,
  ...
  const submitPayment = async () => {
    ...
    const r = await paytmCheckout({
      orderId, amount: 99, service: "Uzbekistan Tourist Visa", mobile, name,
    })
        ...
        <div className="pf5-summary-card">
          ...
          <div className="pf5-summary-rows">
            {[
              ...
              { label: 'Services',             value: 'Uzbekistan Tourist Visa' },
  ...
  return (
    <div className="pf5-page">
      <div className="pf5-breadcrumb">
        <Link href="/">Home</Link><span> / </span><Link href="/uzbekistan-visa">Uzbekistan Visa</Link><span> / </span><span>Form</span>
      </div>
      <div className="pf5-card">
