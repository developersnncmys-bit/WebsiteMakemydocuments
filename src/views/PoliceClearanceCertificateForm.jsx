...
const STEP_META = [
  { title: 'Applying For',               sub: 'Select the purpose of your police clearance certificate', Icon: FileText, gradient: 'linear-gradient(135deg,#1A3D6E,#2E68B1)' },
...
export default function PoliceClearanceCertificateForm() {
  ...
  const submitPayment = async () => {
    ...
    const r = await paytmCheckout({
      orderId, amount: 99, service: "Police Clearance Certificate (PCC)", mobile, name,
    })
