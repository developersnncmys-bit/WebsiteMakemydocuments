...
export default function EgyptVisaForm() {
  ...
  const submitPayment = async () => {
    ...
    const r = await paytmCheckout({
      orderId, amount: 99, service: "Egypt Tourist Visa", mobile, name,
    })
        ...
        <div className="pf5-summary-card">
          ...
          <div className="pf5-summary-rows">
            {[
              ...
              { label: 'Services',             value: 'Egypt Tourist Visa' },
  ...
  return (
    <div className="pf5-page">
      <div className="pf5-breadcrumb">
        <Link href="/">Home</Link><span> / </span><Link href="/egypt-visa">Egypt Visa</Link><span> / </span><span>Form</span>
      </div>
      <div className="pf5-card">
