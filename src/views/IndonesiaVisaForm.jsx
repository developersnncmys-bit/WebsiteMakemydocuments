...
import {
  Globe, Phone, Check, AlertCircle, Wallet, ChevronRight, ChevronLeft, ArrowLeft
} from 'lucide-react'
...
export default function IndonesiaVisaForm() {
  ...
  const verifyOtp = async () => {
    ...
    submitLead({
      orderId,
      service: 'Indonesia Tourist Visa',
      name,
      mobileNumber: mobile,
      email,
      address,
  ...
  const submitPayment = async () => {
    ...
    const r = await paytmCheckout({
      orderId, amount: 99, service: "Indonesia Tourist Visa", mobile, name,
    })
        ...
        <div className="pf5-summary-card">
          ...
          <div className="pf5-summary-rows">
            {[
              ...
              { label: 'Services',             value: 'Indonesia Tourist Visa' },
  ...
  return (
    <div className="pf5-page">
      <div className="pf5-breadcrumb">
        <Link href="/">Home</Link><span> / </span><Link href="/indonesia-tourist-visa-for-indians">Indonesia Visa</Link><span> / </span><span>Form</span>
      </div>
      <div className="pf5-card">
          ...
          {step === 1 && (
            <>
                  ...
                  return (
                    <>
                      <ValidInp valid={isValid}>
                        <input className={`pf5-inp${isPast ? ' pf5-inp-warn' : ''}`} type="date"
                          min={todayStr} value={travelDate}
              ...
              <Field label="Returning Date">
                {(() => {
                  const minReturn  = travelDate ? new Date(new Date(travelDate).getTime() + 86400000).toISOString().split('T')[0] : todayStr
                  ...
                  return (
                    <>
                      <ValidInp valid={isValid}>
                        <input className={`pf5-inp${isNotAfter ? ' pf5-inp-warn' : ''}`} type="date"
                          min={minReturn} value={returnDate}
