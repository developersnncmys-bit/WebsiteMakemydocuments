...
import {
  Bike, FileText, Phone, Check, AlertCircle,
  ChevronRight, ChevronLeft, ArrowLeft,
} from 'lucide-react'
import { getStates, getDistricts, validatePincode } from '../data/locationData'

const TOTAL = 3
const STEPS = ['Intent', 'Bike', 'Contact']

const STEP_META = [
  { title: 'I Want To',           sub: 'Buy / Renew bike insurance without inspection or paperwork', Icon: Bike,     gradient: 'linear-gradient(135deg,#1A3D6E,#2E68B1)' },
  { title: 'Enter Bike Details',  sub: 'Buy Insurance, the smart way',                              Icon: FileText, gradient: 'linear-gradient(135deg,#1A3D6E,#2E68B1)' },
  { title: 'Contact Details',     sub: 'Buy Insurance, the smart way',                              Icon: Phone,    gradient: 'linear-gradient(135deg,#1A3D6E,#2E68B1)' },
]

const INTENT_OPTIONS = [
  { value: 'Buy New Policy',      label: 'Buy New Policy',      desc: 'Purchase a fresh insurance policy for your two-wheeler',   color: '#2E68B1', bg: '#EBF2FB', badge: 'Recommended' },
...
export default function TwoWheelerInsuranceForm() {
