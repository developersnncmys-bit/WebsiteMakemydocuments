...
export default function MoroccoVisaForm() {
  ...
  const submitPayment = async () => {
    ...
    const r = await paytmCheckout({
      orderId, amount: 99, service: "Morocco Tourist Visa", mobile, name,
    })
        ...
        <div className="pf5-summary-card">
          ...
          <div className="pf5-summary-rows">
            {[
              ...
              { label: 'Services',             value: 'Morocco Tourist Visa' },
  ...
  return (
    <div className="pf5-page">
      <div className="pf5-breadcrumb">
        <Link href="/">Home</Link><span> / </span><Link href="/morocco-visa">Morocco Visa</Link><span> / </span><span>Form</span>
      </div>
      <div className="pf5-card">
