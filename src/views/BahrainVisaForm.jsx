...
export default function BahrainVisaForm() {
  ...
  const submitPayment = async () => {
    ...
    const r = await paytmCheckout({
      orderId, amount: 99, service: "Bahrain Tourist Visa", mobile, name,
    })
        ...
        <div className="pf5-summary-card">
          ...
          <div className="pf5-summary-rows">
            {[
              ...
              { label: 'Services',             value: 'Bahrain Tourist Visa' },
  ...
  return (
    <div className="pf5-page">
      <div className="pf5-breadcrumb">
        <Link href="/">Home</Link><span> / </span><Link href="/bahrain-visa">Bahrain Visa</Link><span> / </span><span>Form</span>
      </div>
      <div className="pf5-card">
