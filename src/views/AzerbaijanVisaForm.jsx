...
export default function AzerbaijanVisaForm() {
  ...
  const verifyOtp = async () => {
    ...
    submitLead({
      orderId,
      service: 'Azerbaijan Tourist Visa',
      name,
      mobileNumber: mobile,
      email,
      address,
  ...
  const submitPayment = async () => {
    ...
    const r = await paytmCheckout({
      orderId, amount: 99, service: "Azerbaijan Tourist Visa", mobile, name,
    })
        ...
        <div className="pf5-summary-card">
          ...
          <div className="pf5-summary-rows">
            {[
              ...
              { label: 'Services',             value: 'Azerbaijan Tourist Visa' },
  ...
  return (
    <div className="pf5-page">
      <div className="pf5-breadcrumb">
        <Link href="/">Home</Link><span> / </span><Link href="/azerbaijan-visa">Azerbaijan Visa</Link><span> / </span><span>Form</span>
      </div>
      <div className="pf5-card">
